...
class GroupModel extends Model
{
    ...
    /**
     * Removes all users from a single group.
     *
     * @param int|string $groupId
     *
     * @return bool
     */
    public function removeAllUserFromGroup($groupId)
    {
        cache()->delete("{$groupId}_users");
    ...
    /**
     * Check if permission exists for group
     *
     * @param int $group_id
     * @param int $permission_id
     * @return mixed
     */
    public function checkPermissionForGroup(int $group_id, int $permission_id)
    {
    ...
    /**
     * Removes all permission from a single group.
     *
     * @param int $groupId
     *
     * @return mixed
    ...
    public function getUsersForSystemmails()
    {
        ...
        {
            $users = array_merge($users, $this->getUsersForGroup($group['id']));
        }
