...
<div class="content">
    <form method="POST" action="<?php echo route_to('group.create')?>">
        <div class="row">
            <div class="col-md-6">
                <div class="block">
                    ...
                    <div class="block-content">
                        <?= csrf_field() ?>
                        <div class="mb-3">
                            <label for="username">Name</label><input class="form-control <?php if(session('errors.name')) : ?>is-invalid<?php endif ?>" name="name" id="name" type="text" value="<?= old('name') ?>">
                            <div class="invalid-feedback"><?= session('errors.name') ?></div>
                        </div>
                        <div class="mb-4">
                            <label for="email">Beschreibung</label><input class="form-control <?php if(session('errors.description')) : ?>is-invalid<?php endif ?>" name="description" id="description" type="text" value="<?= old('description') ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <?php foreach ($permissions as $permission): ?>
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" value="true" id="permission[<?=$permission['id'] ?>]" name="permission[<?=$permission['id'] ?>]">
