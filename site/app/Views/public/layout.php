...
<head>
    ...
    <link rel="icon" type="image/png" sizes="192x192" href="<?php echo base_url()?>/assets/media/favicons/favicon-192x192.png?v=3">
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo base_url()?>/assets/media/favicons/apple-touch-icon-180x180.png?v=3">
